...
METADATA = {
    ...
    'description':      'Can you prepare against pitiless fate?',
    'author':           'scav',
    #'author_email':     '',
...
PACKAGEDATA = {
    ...
    'package_dir': {'nemesis_card': 'nemesis_card',
                   },
    'packages': ['nemesis_card',
                ],
    'scripts': ['scripts/nemesis_card'],
}
...
_DATA_DIR = os.path.join('nemesis_card', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'nemesis_card': data_dirs}
...
src = []
add_files(src,os.walk('nemesis_card'))
